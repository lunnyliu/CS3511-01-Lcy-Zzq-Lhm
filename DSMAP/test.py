...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, default='./myDatap', help="Path to the root folder of testing images (ex. ROOT/testA, testB)")
    parser.add_argument('--output_path', type=str, default='./tmp', help="Path to save results")
    parser.add_argument('--checkpoint', type=str, default='./outputs/cat2dog/myData/ckpts/gen_00004200.pt', help="Path to load checkpoint")

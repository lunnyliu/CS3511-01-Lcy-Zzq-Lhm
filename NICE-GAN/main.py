...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='myData', help='dataset_name')

    parser.add_argument('--iteration', type=int, default=4200, help='The number of training iterations')
    ...
    parser.add_argument('--img_size', type=int, default=1024, help='The size of image')
